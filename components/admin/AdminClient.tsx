            ...
            <div className="grid grid-cols-3 gap-3 mb-6">
                {tabs.map(tab => (
                    <button
                        ...
                        className={`border rounded-2xl p-3 text-center transition-all ${activeTab === tab.key ? tab.color : "bg-white border-gray-100"
                            }`}
                    >
                ...
                <div className="space-y-4">
                    {currentList.map(quiz => (
                        <QuizModerationCard
                            key={quiz.id}
                            quiz={quiz}
                            onApprove={activeTab === "pending" ? handleApprove : activeTab === "rejected" ? handleReApprove : undefined}
