    ...
    <main className="pb-24 px-4 py-6">
      ...
      <div className="space-y-3 mb-5">
        {question.options.map((option, i) => {
          let containerStyle = "bg-white border-gray-100 text-gray-900";
          let letterStyle = "bg-purple-100 text-purple-600";

          if (confirmed) {
            if (!isPersonality && option.is_correct) {
              containerStyle = "bg-green-50 border-green-400 text-green-800";
              ...
              containerStyle = "bg-white border-gray-100 text-gray-400 opacity-50";
            }
          } else if (option.id === selected) {
            containerStyle = "bg-purple-50 border-purple-400 text-purple-900";
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 border-2 rounded-2xl px-4 py-3.5 text-left transition-all font-medium ${containerStyle}`}
            >
